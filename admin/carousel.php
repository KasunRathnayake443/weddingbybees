        ...
        <div class="carousel-wrapper">
            <?php while($row = $result->fetch_assoc()) { ?>
                <div class="carousel-image">
                    ...
                    <form style="background-color: transparent; border-color: transparent;" action="carousel.php" method="post" onsubmit="return confirm('Are you sure you want to delete this image?');">
...
if (isset($_FILES['new_image']) && $_FILES['new_image']['error'] === 0) {
    ...
    if (in_array($image_ext, $allowed_ext)) {
        ...
        if (move_uploaded_file($image_tmp_name, $upload_path)) {
            ...
            echo "<script> document.location='carousel.php?notifications1=1';</script>";
            exit();
        } else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id'])) {
        ...
        echo "<script> document.location='carousel.php?notifications2=1';</script>";
    } else {
