        ...
        <div class="carousel-wrapper">
            <?php while($row = $result->fetch_assoc()) { ?>
                <div class="carousel-image">
                    <img src="../images/packages/<?php echo $row['image']; ?>" alt="Carousel Image" />
                    <form style="background-color: transparent; border-color: transparent;" action="packages.php" method="post" onsubmit="return confirm('Are you sure you want to delete this image?');">
...
if (isset($_FILES['new_image']) && $_FILES['new_image']['error'] === 0) {
    ...
    if (in_array($image_ext, $allowed_ext)) {
        ...
        if (move_uploaded_file($image_tmp_name, $upload_path)) {
            ...
            $sql = "INSERT INTO package_images (image) VALUES (?)";
